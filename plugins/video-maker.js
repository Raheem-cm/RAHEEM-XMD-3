...
cmd({
    ...
    await reply("🎬 *Creating video, please wait...*");
    ...
    exec(command, async (err) => {
        if (err) return reply("❌ Make sure you ran `pkg install ffmpeg` in Termux.");
        await conn.sendMessage(from, { video: { url: videoPath }, caption: "✅ Generated!" }, { quoted: mek });
